...
import { ProductReferencePage } from '@/components/product/product-reference-page';
...
import { getProductPageReferencePresentation } from '@/config/product-page-reference';
...
export default async function ProductPage({ params }: ProductPageProps) {
  ...
  const approvedMedia = getApprovedProductMedia(product.id);
  const referencePresentation = getProductPageReferencePresentation(product.id);
