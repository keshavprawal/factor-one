...
export function ProductCard({ name, description, price, href, image }: ProductCardProps) {
  return (
    <article className="group">
      <Link
        href={href}
        className="block transition-transform duration-500 ease-out hover:-translate-y-1 focus-visible:-translate-y-1 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-4 motion-reduce:transform-none"
      >
